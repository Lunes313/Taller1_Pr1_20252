    ...
    def handle(self, *args, **kwargs):
        ...
        for movie in movies:
            ...
            try:
                ...
                prompt = (
                    f"{instruction} "
                        f"Vas a actualizar la descripción '{movie.descripcion}' de la película '{movie.title}'."
                )

                # ✅ Optional: Log current movie data
                print(f"Title: {movie.title}")
                print(f"Original Description: {movie.descripcion}")
                ...
                movie.descripcion = updated_description
                movie.save()
